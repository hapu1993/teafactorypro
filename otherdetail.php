...
$sql="SELECT * FROM other WHERE date='".$date1."'";
...
if (mysqli_num_rows($result)==0){
    echo "<h2 align='center'>".$year1." හි ".$month1 ." මාසයේ ".$day1." දින වෙනත් ගාස්තු නැත</h2>";
  }
  else{
echo "<h2 align='center'>".$year1." හි ".$month1 ." මාසයේ ".$day1." වෙනත් ගාස්තු:</h2>";
?>
...
echo "<table id='myTable' class='table table-bordred table-striped'>";
  ...
  echo "<tr>";
    ...
    <td><p data-placement='top' data-toggle='tooltip' title='Edit'><a href="otheredit.php?id=<?php echo $arr['oth_ref_no']; ?> "><button class='btn btn-primary btn-xs' data-title='Edit' data-toggle='modal'><span class='glyphicon glyphicon-pencil'></span></button></a></p></td>
...
echo "</table>";
$sql2="SELECT SUM(price) AS total FROM other WHERE date='".$date1."'";
$result2=mysqli_query($con,$sql2);
$row2=mysqli_fetch_array($result2);
echo "<h2 align='center'>".$year1." හි ".$month1 ." මාසයේ ".$day1." දින මුලු වෙනත් ගාස්තු:".$row2['total']."</h2>";
}
}
?>
