...
<div align="center">
  ...
  $id=$_GET['id'];
  $sql1="SELECT * FROM outstanding WHERE out_ref_no='$id'";
  ...
  <h4>මාසය :<?php echo $row1['month'];?></h4>
  <h4>වසර :<?php echo $row1['year'];?></h4>
  <h4>පෙර අගය:<?php echo $row1['price'];?></h4>
...
$sql3="UPDATE outstanding SET price='".$_POST['new_value']."' WHERE out_ref_no='".$id."'";
