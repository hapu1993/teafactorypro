...
$sql="SELECT * FROM advance WHERE date='".$date1."'";
...
if (mysqli_num_rows($result)==0){
    echo "<h2 align='center'>".$year1." හි ".$month1 ." මාසයේ ".$day1." දින අත්තිකාරම්  නැත</h2>";
  }
  else{
echo "<h2 align='center'>".$year1." හි ".$month1 ." මාසයේ ".$day1." අත්තිකාරම් :</h2>";
?>
...
echo "<table id='myTable' class='table table-bordred table-striped'>";
  ...
  echo "<tr>";
    ...
    <td><p data-placement='top' data-toggle='tooltip' title='Edit'><a href="advanceedit.php?id=<?php echo $arr['adv_ref_no']; ?> "><button class='btn btn-primary btn-xs' data-title='Edit' data-toggle='modal'><span class='glyphicon glyphicon-pencil'></span></button></a></p></td>
...
echo "</table>";
$sql2="SELECT SUM(price) AS total FROM advance WHERE date='".$date1."'";
$result2=mysqli_query($con,$sql2);
$row2=mysqli_fetch_array($result2);
echo "<h2 align='center'>".$year1." හි ".$month1 ." මාසයේ ".$day1." දින මුලු අත්තිකාරම්:".$row2['total']."</h2>";
}
}
?>
