...
<div class="container-fluid text-center">    
  <h2 align="center">තේ කොළ එකතු කිරීම සඳහා</h2>
   <br>
<br>

 
  <form class="form-inline" action="tealeaves3.php" method="POST"> 
...
<br>
  ...
  <button type="submit" class="btn btn-primary btn-lg" background-color="#3aa00b" name="tealeaves"><font style="color: #040504">එකතු කිරීම</font></button>
