...
$date_value="$year/$month/$day";
	...
	$sql="INSERT INTO dailytea(customer_id,date,weight) VALUES ('".$customer_id."','".$date_value."','".$weight."')";
$result=mysqli_query($con,$sql);
	
	
	if ($result){
		echo "<h2 align='center'>Success</h2>";
	echo "<h3><b>සාර්ථකව දෛනික දළු ප්‍රමාණය එකතු කරන ලදී</b></h3>";
  echo "<br>";
  echo "<a href='dailytea.php'><button type='button' class='btn btn-primary btn-lg' background-color='#3aa00b'><font style='color: #040504'>ආපසු</font></button></a>";
	}
	else {
