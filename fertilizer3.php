...
$date_value="$year/$month/$day";
	...
	$sql="INSERT INTO fertilizer(customer_id,date,price) VALUES ('$customer_id','$date_value','$price')";
	$result=mysqli_query($con,$sql);
	if($result){
	
		echo "<h2><b>Success</b></h2>";
		echo "<h2><b>සාර්ථකව පොහොර මුදල් එකතු කරන ලදී</b></h2>";
    echo "<br>";
    echo "<a href='fertilizer2.php'><button type='button' class='btn btn-primary btn-lg' background-color='#3aa00b'><font style='color: #040504'>ආපසු</font></button></a>";
	}
	else {
