...
<div align="center">
  <div class="btn-group">
   <a href="fertilizer2.php"><button>පොහොර</button></a>
  <a href="advance1.php"><button>අත්තිකාරම්</button></a>
  <a href="dailytea.php"><button>දෛනික තේ කිරුම්</button></a>
  <a href="tealeaves1.php"><button>තේ කොළ</button></a>
  <a href="transport4.php"><button>ප්‍රවාහන ගාස්තු</button></a>
  <a href="other.php"><button>වෙනත් ගාස්තු</button></a>
  <a href="outstanding1.php"><button>හිඟ</button></a>
</div>
 </div>
</body>
</html> 
