	...
	<div class="row">
        <div class="col-md-6">
           <marquee><p style="font-family: Impact; font-size: 18pt">මාවිටවත්ත තේ දළු එකතු කිරීමේ මධ්‍යස්තානය </p></marquee>
            ...
            <form action="factory1.php" enctype="multipart/form-data" method="post">
            <fieldset><legend class="text-center">Valid information is required to register. <span class="req"><small> required *</small></span></legend>
                <h2 align="center">තේ දළු ගැනුම් කරුවන් ලියාපදිංචිය</h2>

            <div class="form-group">
            <label for="nic_no"><span class="req">* </span>Factory ID: </label>
                    <input required type="text" name="factory_id" id="factory_id" class="form-control phone" maxlength="10" onkeyup="validatephone(this);" placeholder="10 charactors"/> 
            </div>

            <div class="form-group"> 	 
                <label for="name"><span class="req">* </span> Factory Name: </label>
                    <input class="form-control" type="text" name="factory_name" id = "txt" onkeyup = "Validate(this)" placeholder="Full Name" required /> 
                        <div id="errFirst"></div>    
            </div>
            ...
            <div class="form-group">
                <label for="mobile_no"><span class="req">* </span> Telephone no:  <small>Please enter a valid Phone Number</small> </label> 
                    <input class="form-control" type="text" name="telephone_no" id = "mobile_no" onkeyup = "Validate(this)" placeholder="Valid Mobile No" required />  
                        <div id="errLast"></div>
            </div>
            <div class="form-group">
                <label for="customer_address"><span class="req">* </span>Factory Address:  <small>Please enter a valid Address</small> </label> 
                    <input class="form-control" type="text" name="factory_address" id = "factory_address" onkeyup = "Validate(this)" placeholder="Valid Address" required />  
                        <div id="errLast"></div>
            </div>
            ...
            <div class="form-group">
                <input class="btn btn-success" type="submit" name="factory" value="Register">
            </div>
