...
<h2 align="center">හිඟ මුදල් එකතු කිරීම සඳහා</h2>
   <br>
<br>
...
<form class="form-inline" action="outstanding2.php" method="POST"> 
...
<br>
  ...
  <a href="outstanding2.php"><button type="submit" class="btn btn-primary btn-lg" background-color="#3aa00b" name="fertilizer"><font style="color: #040504">එකතු කිරීම</font></button>
