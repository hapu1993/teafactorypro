...
$date_value="$year/$month/$day";
	...
	$sql="INSERT INTO tea_leaves(customer_id,date,price) VALUES ('".$customer_id."','".$date_value."','".$price."')";
$result=mysqli_query($con,$sql);
	
	
	if ($result && $arr['customer_id']==$customer_id){
		echo "<h2 align='center'>Success</h2>";
	echo "<h3><b>සාර්ථකව තේ කොළ මුදල් එකතු කරන ලදී</b></h3>";
  echo "<br>";
  echo "<a href='tealeaves1.php'><button type='button' class='btn btn-primary btn-lg' background-color='#3aa00b'><font style='color: #040504'>ආපසු</font></button></a>";
	}
	else {
