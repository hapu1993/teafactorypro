...
<div class="container-fluid text-center">
  ...
  <div class="form-inline input-group col-md-offset-4 col-sm-6 col-md-3">
          <label><font size="5px">දළු කිලෝවක මිල</font></label>
            <input type="text" name="unitprice" placeholder="දළු කිලෝවක මිල" required="required">
            </div>
            <br>
...
if (isset($unitpricebtn)){
  $sql="SELECT * FROM unitprice WHERE month='".$month."' and year='".$year."'";
$result1=mysqli_query($con,$sql);
$arr=mysqli_fetch_array($result1);
if ($month==$arr['month'] && $year==$arr['year']){
  
    echo "<h2>එක් වතාවක් ".$year." හි  ".$month." මාසය සඳහා කිලෝවක මිල ඇතුලත් කර ඇත.</h2>";
...
='color: #040504'>ආපසු</font></button></a>";
	...
	$sql1="INSERT INTO unitprice(price,month,year) VALUES ('".$unitprice."','".$month."','".$year."')";
