...
$date_value="$year/$month/$day";
	...
	$sql="INSERT INTO other(customer_id,date,price) VALUES ('$customer_id','$date_value','$price')";
	$result=mysqli_query($con,$sql);
	
	if ($result){
		echo "<h2 align='center'>Success</h2>";
	echo "<h3>සාර්ථකව වෙනත් ගාස්තු එකතු කරන ලදී</h3>";
  echo "<br>";
  echo "<a href='other.php'><button type='button' class='btn btn-primary btn-lg' background-color='#3aa00b'><font style='color: #040504'>ආපසු</font></button></a>";
