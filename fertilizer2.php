...
<h2 align="center">පොහොර එකතු කිරීම සඳහා</h2>
   <br>
<br>
...
<form class="form-inline" action="fertilizer3.php" method="POST"> 
...
<body>
    ...
    <input type="text" class="form-control" autocomplete="off" name="customer_id" autofocus="auto" required="required">
...
<label style="style='font-size:25px'">මාසය:</label><select name="month" value='month'>
...
<label style="font-size:15px">දිනය:</label><select name="day" value='day'>
...
<label style="font-size:15px">වසර:</label><select name="year" >
...
<br>
  <div class="form-group">
      <label class="control-label col-sm-4" for="price" style="font-size:15px">මුලු මුදල-:</label>
      <div class="col-sm-3">          
        <input type="text" class="form-control" id="price" placeholder="Total Price" name="price" required="required">
      </div>
    </div>
  ...
  <a href="fertilizer2.php"><button type="submit" class="btn btn-primary btn-lg" background-color="#3aa00b" name="fertilizer"><font style="color: #040504">එකතු කිරීම</font></button>
<a href='admin.php'><button type='button' class='btn btn-primary btn-lg' background-color='#3aa00b'><font style='color: #040504'>ආපසු</font></button></a>
</form>
