...
<div align="center">
  <div class="btn-group">
   <a href="fertilizerdetail.php"><button>පොහොර</button></a>
  <a href="advancedetail.php"><button>අත්තිකාරම්</button></a>
  <a href="dailyteadetail.php"><button>දෛනික තේ කිරුම්</button></a>
  <a href="tealeavesdetail.php"><button>තේ කොළ</button></a>
  <a href="transportdetail.php"><button>ප්‍රවාහන ගාස්තු</button></a>
  <a href="otherdetail.php"><button>වෙනත් ගාස්තු</button></a>
  <a href="outstandingdetail.php"><button>හිඟ</button></a>
</div>
 </div>
</body>
</html> 
