...
$sql="SELECT * FROM transport WHERE month='$month1' and year='$year1'";
$result=mysqli_query($con,$sql);


if (mysqli_num_rows($result)==0){
    echo "<h2 align='center'>".$year1." හි ".$month1 ." මාසයේ ප්‍රවාහන ගාස්තු නැත</h2>";
  }
  else{
echo "<h2 align='center'>".$year1." හි ".$month1 ." මාසයේ ප්‍රවාහන ගාස්තු:</h2>";
?>
...
echo "</table>";
$sql2="SELECT SUM(price) AS total FROM transport WHERE month='".$month1."' and year='".$year1."'";
$result2=mysqli_query($con,$sql2);
$row2=mysqli_fetch_array($result2);
echo "<h2 align='center'>".$year1." හි ".$month1 ." මාසයේ මුලු ප්‍රවාහන ගාස්තු".$row2['total']."</h2>";
}
}
?>
