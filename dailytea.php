...
<div class="container-fluid text-center">    
  <h2 align="center">දෛනික දළු ගණන් එකතු කිරීම සඳහා</h2>
   <br>
<br>
...
<form class="form-inline" action="dailytea2.php" method="POST"> 
...
<br>
  <div class="form-group">
      <label class="control-label col-sm-4" for="price" style="font-size:15px">දළු කිලෝ ගණන:</label>
      <div class="col-sm-3">          
        <input type="text" class="form-control" id="price" placeholder="Total Price" name="weight" required="required">
      </div>
    </div>
  ...
  <button type="submit" class="btn btn-primary btn-lg" background-color="#3aa00b" name="submit"><font style="color: #040504">එකතු කිරීම</font></button>
