...
<body>
    ...
    <div class="btn-group">
   <a href="monthdata1.php"><button>දෛනික තොරතුරු ලබාගැනීම සහ යාවත්කාලීන කිරීම</button></a>
  <a href="calculate.php"><button>මාසික බිල පිලිබඳ විස්තර ලබා ගැනීම</button></a>
