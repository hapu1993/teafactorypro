...
<div class="container-fluid text-center">    
  <h2 align="center">ප්‍රවාහන ගාසතු ඇතුලත් කිරීම සඳහා</h2>
   <br>
<br>

 
<form class="form-inline" action="transport2.php" method="POST"> 
...
<br>
  ...
  <button type="submit" class="btn btn-primary btn-lg" background-color="#3aa00b" name="transport"><font style="color: #040504">එකතු කිරීම</font></button>
